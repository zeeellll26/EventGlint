<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditShows.cs" Inherits="EventGlint.Admin.EditShows" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Edit Shows — EventGlint</title>
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="EditShows.aspx"       class="nav-item active"><i class="fas fa-film"></i> Shows</a>
...
<div class="main">
    <div class="topbar">
        <div class="topbar-left"><h2>Edit Shows</h2><p>Schedule screenings and performances for events</p></div>
    ...
    <div class="content">
        <div class="welcome-banner fade-in">
            <div class="greeting">📅 Show Management</div>
            <h1>Show</h1>
            <p>Schedule screenings and performances for events</p>
        </div>
        <div class="section-title">Add / Edit Show</div>
        <div class="body-grid">
            <div class="form-card fade-in">
                <div class="form-card-head">
                    <div class="form-card-icon"><i class="fas fa-film"></i></div>
                    <div><div class="form-card-title">Show Details</div><div class="form-card-sub">Fill in details and click Insert or Save</div></div>
                </div>
                <div class="form-card-body">
                    <asp:Label ID="lblMessage" runat="server" Visible="false" />
                    <div class="field"><label><i class="fas fa-lock" style="opacity:0.4;margin-right:4px"></i>Show ID</label>
                        <asp:TextBox ID="txtShowId" runat="server" ReadOnly="true" placeholder="Auto generated" /></div>
                    <div class="field"><label>Event <span class="req">*</span></label>
                        <asp:DropDownList ID="ddlEventId" runat="server" /></div>
                    <div class="field"><label>Hall <span class="req">*</span></label>
                        <asp:DropDownList ID="ddlHallId" runat="server" /></div>
                    <div class="field"><label>Show Date <span class="req">*</span></label>
                        <asp:TextBox ID="txtShowDate" runat="server" TextMode="Date" /></div>
                    <div class="field"><label>Start Time <span class="req">*</span></label>
                        <asp:TextBox ID="txtStartTime" runat="server" TextMode="Time" /></div>
                    <div class="field"><label>End Time</label>
                        <asp:TextBox ID="txtEndTime" runat="server" TextMode="Time" /></div>
            ...
            <div class="table-card fade-in">
                <div class="table-card-head">
                    <h3><i class="fas fa-table" style="margin-right:8px;color:var(--accent)"></i>All Shows</h3>
                    <span class="count-badge"><asp:Label ID="lblCount" runat="server" Text="0 records" /></span>
                </div>
                <div class="tbl-wrap">
                    <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="false" DataKeyNames="ShowId" GridLines="None" EmptyDataText="No records found." OnRowCommand="gvData_RowCommand">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Actions">
                                <ItemTemplate>
                                    <asp:Button CommandName="SelectRow" CommandArgument='<%# Eval("ShowId") %>' Text="Edit"   CssClass="tbtn tbtn-select" runat="server" />
                                    <asp:Button CommandName="DeleteRow" CommandArgument='<%# Eval("ShowId") %>' Text="Delete" CssClass="tbtn tbtn-delete" runat="server" OnClientClick="return confirm('Delete this record?');" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
