...
<head runat="server">
    <title>Edit Admins — EventGlint</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@600;700&family=DM+Sans:wght@300;400;500;600&display=swap" rel="stylesheet" />
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" rel="stylesheet" />
    <style>
        /* ── Exact CSS variables from AdminPanel ── */
        :root {
            --bg:           #f4f6fb;
            --surface:      #ffffff;
            --card:         #ffffff;
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ════ WELCOME BANNER — exact from AdminPanel ════ */
        .welcome-banner {
        ...
        /* ════ SECTION TITLE — exact from AdminPanel ════ */
        .section-title {
        ...
        .field select:focus {
            ...
            background: white;
            box-shadow: 0 0 0 3px rgba(91,63,248,0.10);
        }
        ...
        .role-super { background: rgba(91,63,248,0.10); color: var(--accent); border: 1px solid rgba(91,63,248,0.2); }
        .role-city  { background: rgba(217,119,6,0.10);  color: var(--gold);    border: 1px solid rgba(217,119,6,0.2); }
        .role-venue { background: rgba(5,150,105,0.10);  color: var(--success); border: 1px solid rgba(5,150,105,0.2); }
        ...
        /* Fade-in animation — same as AdminPanel */
...
<form id="form1" runat="server">
    ...
    <!-- ════ SIDEBAR — copied exactly from AdminPanel ════ -->
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="EditAdmins.aspx"  class="nav-item active"><i class="fas fa-user-shield"></i> Admins</a>
    ...
    <div class="main">
        ...
        <!-- TOPBAR — exact from AdminPanel -->
        <div class="topbar">
            <div class="topbar-left">
                <h2>Edit Admins</h2>
                <p>Add, update or remove admin accounts</p>
            </div>
        ...
        <!-- ════ CONTENT — only this part is new ════ -->
        <div class="content">

            <!-- Welcome Banner — same style as AdminPanel -->
            <div class="welcome-banner fade-in">
                <div class="greeting">🛡️ Admin Management</div>
                <h1>Manage Admin Accounts</h1>
                <p>Add new admins, update their details, or remove accounts from EventGlint.</p>
            </div>
            ...
            <div class="body-grid">
                ...
                <div class="form-card fade-in">
                    <div class="form-card-head">
                        <div class="form-card-icon"><i class="fas fa-user-shield"></i></div>
                        <div>
                            <div class="form-card-title">Admin Details</div>
                    ...
                    <div class="form-card-body">
                        ...
                        <!-- Admin ID -->
                        <div class="field">
                            <label><i class="fas fa-lock" style="margin-right:5px;opacity:0.5"></i>Admin ID</label>
                        ...
                        <div class="field">
                            ...
                            <asp:TextBox ID="txtEmail" runat="server"
                                placeholder="e.g. john@eventglint.com" />
                        </div>
                ...
                <div class="table-card fade-in">
                    <div class="table-card-head">
                        <h3><i class="fas fa-table" style="margin-right:8px;color:var(--accent)"></i>All Admins</h3>
                        ...
                        <asp:GridView ID="gvAdmins" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Role">
                                    <ItemTemplate>
                                        <span class='role-badge <%# GetRoleBadge(Eval("Role").ToString()) %>'>
                                            <%# Eval("Role") %>
                                        </span>
                                    </ItemTemplate>
                                </asp:TemplateField>
...
<!-- Live clock — exact from AdminPanel -->
<script>
