...
<head runat="server">
    <title>Edit Events — EventGlint</title>
    ...
    <style>
        ...
        * {
        ...
        .btn-insert {
            background: linear-gradient(135deg,var(--accent),var(--accent2));
            color: white;
            box-shadow: 0 3px 12px rgba(91,63,248,0.25);
        }
        ...
        thead tr {
            background: rgba(91,63,248,0.04);
        }
        ...
        tbody tr {
            ...
            tbody tr:hover {
                background: rgba(91,63,248,0.03);
            }
    ...
    <form id="form1" runat="server">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="EditEvents.aspx" class="nav-item active"><i class="fas fa-calendar-star"></i>Events</a>
        ...
        <div class="main">
            <div class="topbar">
                <div class="topbar-left">
                    <h2>Edit Events</h2>
                    <p>Manage movies, concerts, sports and plays</p>
                </div>
                <div class="topbar-right">
                    <div class="topbar-time" id="liveTime"></div>
                    <div class="admin-avatar">
                        <asp:Label ID="lbl_AvatarInitial" runat="server" Text="A" /></div>
                </div>
            </div>
            <div class="content">
                <div class="welcome-banner fade-in">
                    <div class="greeting">🎬 Event Management</div>
                    <h1>Manage Events</h1>
                    <p>Add movies, concerts, sports events and plays to the platform.</p>
                </div>
                <div class="section-title">Add / Edit Event</div>
                <div class="body-grid">
                    <div class="form-card fade-in">
                        <div class="form-card-head">
                            <div class="form-card-icon"><i class="fas fa-calendar-star"></i></div>
                            <div>
                        ...
                        <div class="form-card-body">
                            ...
                            <div class="field">
                                <label><i class="fas fa-lock" style="opacity: 0.4; margin-right: 4px"></i>Event ID</label>
                                <asp:TextBox ID="txtEventId" runat="server" ReadOnly="true" placeholder="Auto generated" />
                            </div>
                            <div class="field">
                                <label>Title <span class="req">*</span></label>
                                <asp:TextBox ID="txtTitle" runat="server" placeholder="e.g. Pushpa 2" />
                            </div>
                            <div class="field">
                                ...
                                <asp:DropDownList ID="ddlEventType" runat="server">
                                    ...
                                    <asp:ListItem Text="Play" Value="Play" />
                            ...
                            <div class="field">
                                ...
                                <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" Rows="3" placeholder="Short description..." />
                            </div>
                            <div class="field">
                                <label>Duration (mins)</label>
                                <asp:TextBox ID="txtDuration" runat="server" placeholder="e.g. 150" TextMode="Number" />
                            </div>
                            <div class="field">
                                <label>Language</label>
                                <asp:TextBox ID="txtLanguage" runat="server" placeholder="e.g. Hindi" />
                            </div>
                            <div class="field">
                                <label>Genre</label>
                                <asp:TextBox ID="txtGenre" runat="server" placeholder="e.g. Action, Drama" />
                            </div>
                            <div class="field">
                    ...
                    <div class="table-card fade-in">
                        <div class="table-card-head">
                            <h3><i class="fas fa-table" style="margin-right: 8px; color: var(--accent)"></i>All Events</h3>
                            <span class="count-badge">
                                <asp:Label ID="lblCount" runat="server" Text="0 records" /></span>
                        </div>
                        <div class="tbl-wrap">
                            <asp:GridView ID="gvEvents" runat="server" AutoGenerateColumns="false" DataKeyNames="EventId" GridLines="None" EmptyDataText="No events found." OnRowCommand="gvEvents_RowCommand">
                                <Columns>
                                    <asp:BoundField DataField="EventId" HeaderText="ID" />
                                    <asp:BoundField DataField="Title" HeaderText="Title" />
                                    <asp:BoundField DataField="EventType" HeaderText="Type" />
                                    <asp:BoundField DataField="Language" HeaderText="Language" />
                                    <asp:BoundField DataField="DurationMins" HeaderText="Mins" />
                                    <asp:BoundField DataField="ReleaseDate" HeaderText="Release" DataFormatString="{0:dd-MM-yyyy}" />
                                    <asp:TemplateField HeaderText="Actions">
                                        <ItemTemplate>
                                            <asp:Button CommandName="SelectRow" CommandArgument='<%# Eval("EventId") %>' Text="Edit" CssClass="tbtn tbtn-select" runat="server" />
                                            <asp:Button CommandName="DeleteRow" CommandArgument='<%# Eval("EventId") %>' Text="Delete" CssClass="tbtn tbtn-delete" runat="server" OnClientClick="return confirm('Delete this event?');" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
