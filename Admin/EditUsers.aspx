<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditUsers.cs" Inherits="EventGlint.Admin.EditUsers" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Edit Users — EventGlint</title>
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="EditUsers.aspx"   class="nav-item active"><i class="fas fa-users"></i> Users</a>
...
<div class="main">
    <div class="topbar">
        <div class="topbar-left"><h2>Edit Users</h2><p>Manage registered customer accounts</p></div>
    ...
    <div class="content">
        ...
        <div class="section-title">Add / Edit User</div>
        <div class="body-grid">
            <div class="form-card fade-in">
                <div class="form-card-head">
                    <div class="form-card-icon"><i class="fas fa-users"></i></div>
                    <div><div class="form-card-title">User Details</div><div class="form-card-sub">Fill in details and click Insert or Save</div></div>
                </div>
                <div class="form-card-body">
                    <asp:Label ID="lblMessage" runat="server" Visible="false" />
                    <div class="field"><label><i class="fas fa-lock" style="opacity:0.4;margin-right:4px"></i>User ID</label>
                        <asp:TextBox ID="txtUserId" runat="server" ReadOnly="true" placeholder="Auto generated" /></div>
                    <div class="field"><label>Username <span class="req">*</span></label>
                        <asp:TextBox ID="txtUsername" runat="server" placeholder="e.g. rahul_patel" /></div>
                    <div class="field"><label>Email <span class="req">*</span></label>
                        <asp:TextBox ID="txtEmail" runat="server" placeholder="e.g. rahul@gmail.com" /></div>
                    <div class="field"><label>Phone</label>
                        <asp:TextBox ID="txtPhone" runat="server" placeholder="e.g. 9876543210" /></div>
                    <div class="field"><label>Password <span class="req">*</span></label>
                        <asp:TextBox ID="txtPassword" runat="server" placeholder="Enter password" /></div>
                    <div class="field"><label>Profile Pic URL</label>
                        <asp:TextBox ID="txtProfilePic" runat="server" placeholder="https://..." /></div>
                    <div class="field"><label>Date of Birth</label>
                        <asp:TextBox ID="txtDOB" runat="server" TextMode="Date" /></div>
            ...
            <div class="table-card fade-in">
                <div class="table-card-head">
                    <h3><i class="fas fa-table" style="margin-right:8px;color:var(--accent)"></i>All Users</h3>
                    <span class="count-badge"><asp:Label ID="lblCount" runat="server" Text="0 records" /></span>
                </div>
                <div class="tbl-wrap">
                    <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="false" DataKeyNames="UserId" GridLines="None" EmptyDataText="No records found." OnRowCommand="gvData_RowCommand">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Actions">
                                <ItemTemplate>
                                    <asp:Button CommandName="SelectRow" CommandArgument='<%# Eval("UserId") %>' Text="Edit"   CssClass="tbtn tbtn-select" runat="server" />
                                    <asp:Button CommandName="DeleteRow" CommandArgument='<%# Eval("UserId") %>' Text="Delete" CssClass="tbtn tbtn-delete" runat="server" OnClientClick="return confirm('Delete this record?');" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
