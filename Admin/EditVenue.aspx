<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditVenue.cs" Inherits="EventGlint.Admin.EditVenue" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Edit Venues — EventGlint</title>
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="EditVenue.aspx"          class="nav-item active"><i class="fas fa-building"></i> Venues</a>
...
<div class="main">
    <div class="topbar">
        <div class="topbar-left"><h2>Edit Venues</h2><p>Manage cinemas, theatres and stadiums</p></div>
    ...
    <div class="content">
        <div class="welcome-banner fade-in">
            <div class="greeting">🏟️ Venue Management</div>
            <h1>Venue</h1>
            <p>Manage cinemas, theatres and stadiums</p>
        </div>
        <div class="section-title">Add / Edit Venue</div>
        <div class="body-grid">
            <div class="form-card fade-in">
                <div class="form-card-head">
                    <div class="form-card-icon"><i class="fas fa-building"></i></div>
                    <div><div class="form-card-title">Venue Details</div><div class="form-card-sub">Fill in details and click Insert or Save</div></div>
                </div>
                <div class="form-card-body">
                    <asp:Label ID="lblMessage" runat="server" Visible="false" />
                    <div class="field"><label><i class="fas fa-lock" style="opacity:0.4;margin-right:4px"></i>Venue ID</label>
                        <asp:TextBox ID="txtVenueId" runat="server" ReadOnly="true" placeholder="Auto generated" /></div>
                    <div class="field"><label>Venue Name <span class="req">*</span></label>
                        <asp:DropDownList ID="ddlVenueName" runat="server" /></div>
                    <div class="field"><label>City <span class="req">*</span></label>
                        <asp:DropDownList ID="ddlCityId" runat="server" /></div>
                    <div class="field"><label>Address <span class="req">*</span></label>
                        <asp:TextBox ID="txtAddress" runat="server" TextMode="MultiLine" Rows="2" placeholder="Full address..." /></div>
                    <div class="field"><label>Phone</label>
                        <asp:TextBox ID="txtPhone" runat="server" placeholder="e.g. 02612345678" /></div>
                    <div class="field"><label>Email</label>
                        <asp:TextBox ID="txtEmail" runat="server" placeholder="e.g. venue@eventglint.com" /></div>
                    <div class="field"><label>Amenities</label>
                        <asp:TextBox ID="txtAmenities" runat="server" placeholder='e.g. ["Parking","WiFi"]' /></div>
                    <div class="field"><label>Images</label>
                        <asp:TextBox ID="txtImages" runat="server" placeholder='e.g. ["url1","url2"]' /></div>
                    <div class="btn-row">
            ...
            <div class="table-card fade-in">
                <div class="table-card-head">
                    <h3><i class="fas fa-table" style="margin-right:8px;color:var(--accent)"></i>All Venues</h3>
                    <span class="count-badge"><asp:Label ID="lblCount" runat="server" Text="0 records" /></span>
                </div>
                <div class="tbl-wrap">
                    <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="false" DataKeyNames="VenueId" GridLines="None" EmptyDataText="No records found." OnRowCommand="gvData_RowCommand">
                        <Columns>
                            <asp:BoundField DataField="VenueId" HeaderText="ID" />
                            ...
                            <asp:TemplateField HeaderText="Actions">
                                <ItemTemplate>
                                    <asp:Button CommandName="SelectRow" CommandArgument='<%# Eval("VenueId") %>' Text="Edit"   CssClass="tbtn tbtn-select" runat="server" />
                                    <asp:Button CommandName="DeleteRow" CommandArgument='<%# Eval("VenueId") %>' Text="Delete" CssClass="tbtn tbtn-delete" runat="server" OnClientClick="return confirm('Delete this record?');" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
