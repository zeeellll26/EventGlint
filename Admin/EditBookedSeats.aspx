...
<head runat="server">
    <title>Edit Booked Seats — EventGlint</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .sidebar-logo .badge {
            ...
            border: 1px solid rgba(91,63,248,0.18); padding: 3px 10px; border-radius: 20px;
        }
        ...
        .field select:focus {
            ...
            background: white; box-shadow: 0 0 0 3px rgba(91,63,248,0.10);
        }
        ...
        .count-badge {
            ...
            background: var(--accent-light); border: 1px solid rgba(91,63,248,0.18);
        ...
        tbody td { padding: 12px 16px; font-size: 13px; color: var(--sub); white-space: nowrap; }
        ...
        .s-held      { background: rgba(217,119,6,0.10); color: var(--gold); border: 1px solid rgba(217,119,6,0.25); }
        .s-released  { background: #fee2e2; color: var(--danger); border: 1px solid #fca5a5; }
        ...
        .tbtn-delete { background: #fff1f1; color: var(--danger); border: 1px solid #fecaca; margin-left: 5px; }
...
<form id="form1" runat="server">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="EditBookedSeats.aspx" class="nav-item active"><i class="fas fa-chair"></i> Booked Seats</a>
    ...
    <div class="main">
        ...
        <div class="topbar">
            <div class="topbar-left">
                <h2>Edit Booked Seats</h2>
                <p>View, add or manage seat booking records</p>
            </div>
            <div class="topbar-right">
                <div class="topbar-time" id="liveTime"></div>
                <div class="admin-avatar">
                    <asp:Label ID="lbl_AvatarInitial" runat="server" Text="A" />
                </div>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="welcome-banner fade-in">
                <div class="greeting">💺 Seat Management</div>
                <h1>Booked Seats</h1>
                <p>Manage all seat booking records — view held, confirmed and released seats.</p>
            </div>

            <div class="section-title">Add / Edit Booked Seat</div>
            ...
            <div class="body-grid">
                ...
                <div class="form-card fade-in">
                    <div class="form-card-head">
                        <div class="form-card-icon"><i class="fas fa-chair"></i></div>
                        <div>
                            <div class="form-card-title">Seat Booking Details</div>
                            <div class="form-card-sub">Fill in the fields and click Insert or Save</div>
                        </div>
                    </div>
                    <div class="form-card-body">
                        ...
                        <!-- Booked Seat ID -->
                        <div class="field">
                            <label><i class="fas fa-lock" style="margin-right:5px;opacity:0.5"></i>Booked Seat ID</label>
                            <asp:TextBox ID="txtBookedSeatId" runat="server"
                                ReadOnly="true" placeholder="Auto generated" />
                        </div>

                        <!-- Booking ID -->
                        <div class="field">
                            <label>Booking ID <span class="req">*</span></label>
                            <asp:TextBox ID="txtBookingId" runat="server"
                                placeholder="Enter Booking ID" TextMode="Number" />
                        </div>

                        <!-- Seat ID -->
                        <div class="field">
                            <label>Seat ID <span class="req">*</span></label>
                            <asp:TextBox ID="txtSeatId" runat="server"
                                placeholder="Enter Seat ID" TextMode="Number" />
                        </div>

                        <!-- Show ID -->
                        <div class="field">
                            <label>Show ID <span class="req">*</span></label>
                            <asp:TextBox ID="txtShowId" runat="server"
                                placeholder="Enter Show ID" TextMode="Number" />
                        </div>

                        <!-- Price Paid -->
                        <div class="field">
                            <label>Price Paid (₹) <span class="req">*</span></label>
                            <asp:TextBox ID="txtPricePaid" runat="server"
                                placeholder="e.g. 250.00" TextMode="Number" />
                        </div>
                        ...
                        <div class="field">
                            ...
                            <asp:TextBox ID="txtHeldUntil" runat="server"
                                TextMode="DateTimeLocal" placeholder="Optional — for held seats" />
                        </div>

                        <!-- Buttons -->
                        <div class="btn-row">
                            <asp:Button ID="btnInsert" runat="server"
                                Text="Insert" CssClass="btn btn-insert"
                                OnClick="btnInsert_Click" />
                            <asp:Button ID="btnSave" runat="server"
                                Text="Save" CssClass="btn btn-save"
                                OnClick="btnSave_Click" />
                            <asp:Button ID="btnClear" runat="server"
                                Text="Clear" CssClass="btn btn-clear"
                ...
                <div class="table-card fade-in">
                    <div class="table-card-head">
                        <h3><i class="fas fa-table" style="margin-right:8px;color:var(--accent)"></i>All Booked Seats</h3>
                        <span class="count-badge">
                            <asp:Label ID="lblCount" runat="server" Text="0 records" />
                        </span>
                    </div>
                    <div class="tbl-wrap">
                        <asp:GridView ID="gvBookedSeats" runat="server"
                            AutoGenerateColumns="false"
                            DataKeyNames="BookedSeatId"
                            GridLines="None"
                            EmptyDataText="No booked seats found."
                            OnRowCommand="gvBookedSeats_RowCommand">
                            <Columns>

                                <asp:BoundField DataField="BookedSeatId" HeaderText="ID" />
                                <asp:BoundField DataField="BookingId"    HeaderText="Booking ID" />
                                <asp:BoundField DataField="SeatId"       HeaderText="Seat ID" />
                                ...
                                <asp:TemplateField HeaderText="Status">
                                    <ItemTemplate>
                                        <span class='status-badge <%# GetStatusBadge(Eval("Status").ToString()) %>'>
                                            <%# Eval("Status") %>
                                        </span>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:BoundField DataField="HeldUntil" HeaderText="Held Until"
                                ...
                                <asp:TemplateField HeaderText="Actions">
                                    <ItemTemplate>
                                        <asp:Button
                                            ...
                                            CommandArgument='<%# Eval("BookedSeatId") %>'
                                            Text="Edit"
                                            CssClass="tbtn tbtn-select"
                                            runat="server" />
                                        <asp:Button
                                            CommandName="DeleteRow"
                                            CommandArgument='<%# Eval("BookedSeatId") %>'
                                            Text="Delete"
                                            CssClass="tbtn tbtn-delete"
                                            runat="server"
