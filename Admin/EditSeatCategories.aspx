<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditSeatCategories.cs" Inherits="EventGlint.Admin.EditSeatCategories" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Edit Seat Categories — EventGlint</title>
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="EditSeatCategories.aspx" class="nav-item active"><i class="fas fa-tags"></i> Seat Categories</a>
...
<div class="main">
    <div class="topbar">
        <div class="topbar-left"><h2>Edit Seat Categories</h2><p>Manage Silver, Gold and Platinum seat categories per hall</p></div>
    ...
    <div class="content">
        <div class="welcome-banner fade-in">
            <div class="greeting">🎫 Seat Category Management</div>
            <h1>Seat Category</h1>
            <p>Manage Silver, Gold and Platinum seat categories per hall</p>
        </div>
        <div class="section-title">Add / Edit Seat Category</div>
        <div class="body-grid">
            <div class="form-card fade-in">
                <div class="form-card-head">
                    <div class="form-card-icon"><i class="fas fa-tags"></i></div>
                    <div><div class="form-card-title">Seat Category Details</div><div class="form-card-sub">Fill in details and click Insert or Save</div></div>
                </div>
                <div class="form-card-body">
                    <asp:Label ID="lblMessage" runat="server" Visible="false" />
                    <div class="field"><label><i class="fas fa-lock" style="opacity:0.4;margin-right:4px"></i>Category ID</label>
                        <asp:TextBox ID="txtCategoryId" runat="server" ReadOnly="true" placeholder="Auto generated" /></div>
                    <div class="field"><label>Hall Name <span class="req">*</span></label>
                        <asp:DropDownList ID="ddlHallId" runat="server" /></div>
                    <div class="field"><label>Seat Category Name <span class="req">*</span></label>
                        <div class="radio-group">
                            <label class="radio-item"><asp:RadioButton ID="rbSilver"   runat="server" GroupName="CatName" Text="Silver" /></label>
                            <label class="radio-item"><asp:RadioButton ID="rbGold"     runat="server" GroupName="CatName" Text="Gold" /></label>
                            <label class="radio-item"><asp:RadioButton ID="rbPlatinum" runat="server" GroupName="CatName" Text="Platinum" /></label>
                        </div></div>
                    <div class="field"><label>Price (Rs.) <span class="req">*</span></label>
                        <asp:TextBox ID="txtPrice" runat="server" placeholder="e.g. 250.00" TextMode="Number" /></div>
                    <div class="field"><label>Color Code</label>
                        <asp:TextBox ID="txtColorCode" runat="server" placeholder="e.g. #f59e0b" /></div>
                    <div class="btn-row">
            ...
            <div class="table-card fade-in">
                <div class="table-card-head">
                    <h3><i class="fas fa-table" style="margin-right:8px;color:var(--accent)"></i>All Seat Categorys</h3>
                    <span class="count-badge"><asp:Label ID="lblCount" runat="server" Text="0 records" /></span>
                </div>
                <div class="tbl-wrap">
                    <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="false" DataKeyNames="CategoryId" GridLines="None" EmptyDataText="No records found." OnRowCommand="gvData_RowCommand">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Actions">
                                <ItemTemplate>
                                    <asp:Button CommandName="SelectRow" CommandArgument='<%# Eval("CategoryId") %>' Text="Edit"   CssClass="tbtn tbtn-select" runat="server" />
                                    <asp:Button CommandName="DeleteRow" CommandArgument='<%# Eval("CategoryId") %>' Text="Delete" CssClass="tbtn tbtn-delete" runat="server" OnClientClick="return confirm('Delete this record?');" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
