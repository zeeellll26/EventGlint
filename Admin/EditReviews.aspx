<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditReviews.cs" Inherits="EventGlint.Admin.EditReviews" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Edit Reviews — EventGlint</title>
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="EditReviews.aspx" class="nav-item active"><i class="fas fa-star"></i> Reviews</a>
    </nav>
    <div class="sidebar-footer"><a href="../Log.aspx" class="logout-btn"><i class="fas fa-arrow-right-from-bracket"></i> Logout</a></div>
</aside>
<div class="main">
    <div class="topbar">
        <div class="topbar-left"><h2>Edit Reviews</h2><p>Moderate and manage user reviews for events</p></div>
    ...
    <div class="content">
        <div class="welcome-banner fade-in">
            <div class="greeting">⭐ Review Management</div>
            <h1>Review</h1>
            <p>Moderate and manage user reviews for events</p>
        </div>
        <div class="section-title">Add / Edit Review</div>
        <div class="body-grid">
            <div class="form-card fade-in">
                <div class="form-card-head">
                    <div class="form-card-icon"><i class="fas fa-star"></i></div>
                    <div><div class="form-card-title">Review Details</div><div class="form-card-sub">Fill in details and click Insert or Save</div></div>
                </div>
                <div class="form-card-body">
                    <asp:Label ID="lblMessage" runat="server" Visible="false" />
                    <div class="field"><label><i class="fas fa-lock" style="opacity:0.4;margin-right:4px"></i>Review ID</label>
                        <asp:TextBox ID="txtReviewId" runat="server" ReadOnly="true" placeholder="Auto generated" /></div>
                    <div class="field"><label>User <span class="req">*</span></label>
                        <asp:DropDownList ID="ddlUserId" runat="server" /></div>
                    <div class="field"><label>Event <span class="req">*</span></label>
                        <asp:DropDownList ID="ddlEventId" runat="server" /></div>
                    <div class="field"><label>Rating (1–5) <span class="req">*</span></label>
                        <asp:DropDownList ID="ddlRating" runat="server">
                            ...
                            <asp:ListItem Text="⭐⭐⭐⭐ 4 - Great" Value="4" />
                            <asp:ListItem Text="⭐⭐⭐⭐⭐ 5 - Excellent" Value="5" />
                        </asp:DropDownList></div>
                    <div class="field"><label>Review Text</label>
                        <asp:TextBox ID="txtReviewText" runat="server" TextMode="MultiLine" Rows="3" placeholder="User review..." /></div>
                    <div class="btn-row">
            ...
            <div class="table-card fade-in">
                <div class="table-card-head">
                    <h3><i class="fas fa-table" style="margin-right:8px;color:var(--accent)"></i>All Reviews</h3>
                    <span class="count-badge"><asp:Label ID="lblCount" runat="server" Text="0 records" /></span>
                </div>
                <div class="tbl-wrap">
                    <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="false" DataKeyNames="ReviewId" GridLines="None" EmptyDataText="No records found." OnRowCommand="gvData_RowCommand">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Actions">
                                <ItemTemplate>
                                    <asp:Button CommandName="SelectRow" CommandArgument='<%# Eval("ReviewId") %>' Text="Edit"   CssClass="tbtn tbtn-select" runat="server" />
                                    <asp:Button CommandName="DeleteRow" CommandArgument='<%# Eval("ReviewId") %>' Text="Delete" CssClass="tbtn tbtn-delete" runat="server" OnClientClick="return confirm('Delete this record?');" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
