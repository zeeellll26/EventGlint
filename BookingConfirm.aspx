...
<head runat="server">
    ...
    <style>
        ...
        *,*::before,*::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .detail-row { display:flex; justify-content:space-between; padding:9px 0; border-bottom:1px solid var(--border-soft); font-size:14px; }
        ...
        /* Seats */
        .seat-chips { display:flex; flex-wrap:wrap; gap:8px; margin-top:6px; }
...
<div class="layout">
    ...
    <main class="main">
        <header class="topbar">
            <div style="font-family:'Playfair Display',serif;font-size:18px;font-weight:800;color:var(--text)">🎉 Booking Confirmed</div>
        </header>
        <div class="content">
            <div class="confirm-card">
                ...
                <div class="details-panel">
                    ...
                    <div class="details-body">
                        <div class="detail-row"><span class="lbl">Event</span><span class="val"><asp:Label ID="lblEvent" runat="server" Text="—" /></span></div>
                        <div class="detail-row"><span class="lbl">Date & Time</span><span class="val"><asp:Label ID="lblShowDate" runat="server" Text="—" /></span></div>
                        <div class="detail-row"><span class="lbl">Venue</span><span class="val"><asp:Label ID="lblVenue" runat="server" Text="—" /></span></div>
                        <div class="detail-row"><span class="lbl">Hall</span><span class="val"><asp:Label ID="lblHall" runat="server" Text="—" /></span></div>
