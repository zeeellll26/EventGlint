    <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowPayment.aspx.cs" Inherits="EventGlint.ShowPayment" %>
    <!DOCTYPE html>
    <html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        <title>EventGlint | Show Payment</title>
        ...
        <style>
            ...
            *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
            ...
            .booking-banner{background:linear-gradient(135deg,#5B21B6,#7C3AED,#A855F7);border-radius:18px;padding:24px 28px;display:flex;align-items:center;gap:20px;margin-bottom:24px;box-shadow:0 4px 20px rgba(124,58,237,.10);}
    ...
    <div class="layout">
        ...
        <main class="main">
            <header class="topbar">
                ...
                <div class="topbar-title">💳 Show Payment</div>
            ...
            <div class="content">
                ...
                <div class="booking-banner">
                    <div class="icon">🎭</div>
                    <div>
                        <h2>Complete Your Show Booking</h2>
                        <p>Your seats are held for 10 minutes. Pay now to confirm.</p>
                ...
                <div class="pay-grid">
                    <div>
                        <div class="panel">
                            <div class="panel-head"><div class="panel-icon">💳</div><div class="panel-title">Choose Payment Method</div></div>
                            <div class="panel-body">
                                <div class="pay-methods">
                                    <div class="pay-method selected" onclick="selectMethod(this,'upi')">
                                        <div class="pay-method-icon">📱</div>
                                        <div><div class="pay-method-label">UPI</div><div class="pay-method-sub">GPay, PhonePe, Paytm</div></div>
                                    ...
                                    <div class="pay-method" onclick="selectMethod(this,'card')">
                                        <div class="pay-method-icon">💳</div>
                                        <div><div class="pay-method-label">Credit / Debit Card</div><div class="pay-method-sub">Visa, Mastercard, RuPay</div></div>
                                        <div class="pay-method-radio"></div>
                                    </div>
                                    <div class="card-inputs" id="cardWrap">
                                        <div><div class="field-label">Card Number</div><input type="text" class="field-input" id="cardNum" maxlength="19" placeholder="1234 5678 9012 3456" oninput="fmtCard(this)" /></div>
                                        <div class="card-row">
                                            <div style="flex:1"><div class="field-label">Expiry</div><input type="text" class="field-input" id="cardExp" maxlength="5" placeholder="MM/YY" oninput="fmtExp(this)" /></div>
                                            <div style="flex:1"><div class="field-label">CVV</div><input type="password" class="field-input" id="cardCvv" maxlength="4" placeholder="•••" /></div>
                                        </div>
                                        <div><div class="field-label">Name on Card</div><input type="text" class="field-input" id="cardName" placeholder="As printed on card" /></div>
                                    </div>
                                    <div class="pay-method" onclick="selectMethod(this,'netbanking')">
                                        <div class="pay-method-icon">🏦</div>
                                        <div><div class="pay-method-label">Net Banking</div><div class="pay-method-sub">All major Indian banks</div></div>
                                        <div class="pay-method-radio"></div>
                                    </div>
                                    <div class="pay-method" onclick="selectMethod(this,'cash')">
                                        <div class="pay-method-icon">💵</div>
                                        <div><div class="pay-method-label">Pay at Venue</div><div class="pay-method-sub">Cash counter at the venue</div></div>
                                        <div class="pay-method-radio"></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel">
                            <div class="panel-head"><div class="panel-icon">🎟️</div><div class="panel-title">Booking Details</div></div>
                            <div class="panel-body">
                                <div class="info-row"><span class="lbl">Show</span><span class="val"><asp:Label ID="lblShow" runat="server" Text="—" /></span></div>
                                <div class="info-row"><span class="lbl">Date & Time</span><span class="val"><asp:Label ID="lblDateTime" runat="server" Text="—" /></span></div>
                                <div class="info-row"><span class="lbl">Venue / Hall</span><span class="val"><asp:Label ID="lblVenue" runat="server" Text="—" /></span></div>
                                <div class="info-row"><span class="lbl">Seats</span><span class="val"><asp:Label ID="lblSeats" runat="server" Text="—" /></span></div>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div class="order-panel">
                            <div class="order-head"><h3>🧾 Amount Due</h3><p>Review before paying</p></div>
                            <div class="order-body">
                                <div class="info-row"><span class="lbl">Subtotal</span><span class="val">₹<asp:Label ID="lblSubtotal" runat="server" Text="0" /></span></div>
                            ...
                            <div class="order-total"><span class="lbl">Total</span><span class="val">₹<asp:Label ID="lblTotal" runat="server" Text="0" /></span></div>
                            <div style="padding:14px 18px;">
                                <asp:Button ID="btnPay" runat="server" Text="✅ Confirm & Pay Now" CssClass="pay-btn" OnClick="btnPay_Click" OnClientClick="return validatePayment();" />
                                <div style="text-align:center;margin-top:10px;font-size:11px;color:var(--muted);">🔒 256-bit SSL secured payment</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function selectMethod(el,method){
            ...
            el.classList.add('selected'); currentMethod=method;
        ...
        function validatePayment(){
            if(currentMethod==='upi'){var upi=document.getElementById('upiId').value.trim();if(!upi||!upi.includes('@')){alert('Please enter a valid UPI ID.');return false;}}
