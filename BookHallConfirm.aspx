<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookHallConfirm.aspx.cs" Inherits="EventGlint.BookHallConfirm" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>EventGlint | Hall Booking Confirmed</title>
    ...
    <style>
        ...
        *,*::before,*::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        /* ── NEXT STEPS ── */
        .next-steps { background:var(--surface); border:1px solid var(--border-soft); border-radius:var(--radius); box-shadow:var(--shadow-md); overflow:hidden; margin-bottom:20px; }
        .ns-head { padding:16px 22px; border-bottom:1px solid var(--border-soft); font-family:'Playfair Display',serif; font-size:16px; font-weight:800; color:var(--text); }
        .ns-body { padding:20px 22px; display:flex; flex-direction:column; gap:14px; }
        .ns-item { display:flex; gap:14px; align-items:flex-start; }
        .ns-icon { width:40px; height:40px; border-radius:12px; background:var(--violet-soft); display:grid; place-items:center; font-size:18px; flex-shrink:0; }
        .ns-text strong { font-size:14px; font-weight:700; color:var(--text); display:block; margin-bottom:3px; }
        .ns-text span   { font-size:12px; color:var(--muted); }
        ...
        .confirm-card > *:nth-child(4) { animation-delay:.3s; }
...
<div class="layout">
    ...
    <main class="main">
        <header class="topbar">
            <div class="topbar-title">🎉 Hall Booking Confirmed</div>
        </header>
        <div class="content">
            <div class="confirm-card">
                ...
                <div class="success-banner">
                    ...
                    <div class="success-title">Hall Booked Successfully!</div>
                    <div class="success-sub">Your hall is reserved. We'll be in touch shortly with more details.</div>
                ...
                <div class="details-panel">
                    ...
                    <div class="details-body">
                        ...
                        <div class="detail-row">
                            ...
                            <span class="val"><asp:Label ID="lblDate"     runat="server" Text="—" /></span>
                        </div>
                        <div class="detail-row">
                            <span class="lbl">Duration</span>
                            <span class="val"><asp:Label ID="lblDuration" runat="server" Text="—" /></span>
                        </div>
                        <div class="detail-row">
                            <span class="lbl">Start Time</span>
                            <span class="val"><asp:Label ID="lblStartTime" runat="server" Text="—" /></span>
                        </div>
                        <div class="detail-row">
                            <span class="lbl">Purpose</span>
                            <span class="val"><asp:Label ID="lblPurpose"  runat="server" Text="—" /></span>
                        </div>
                        <div class="detail-row">
                            <span class="lbl">Guests</span>
                            <span class="val"><asp:Label ID="lblGuests"   runat="server" Text="—" /></span>
                        </div>
                        <div class="detail-row">
                            <span class="lbl">Hall Rent</span>
                ...
                <div class="next-steps">
                    <div class="ns-head">📋 What Happens Next?</div>
                    <div class="ns-body">
                        <div class="ns-item">
                            <div class="ns-icon">📧</div>
                            <div class="ns-text">
                                <strong>Confirmation Email</strong>
                                <span>A confirmation with your booking reference will be sent to your registered email.</span>
                            </div>
                        </div>
                        <div class="ns-item">
                            <div class="ns-icon">📞</div>
                            <div class="ns-text">
                                <strong>Venue Will Contact You</strong>
                                <span>The venue team will reach out 48 hours before your booking date to discuss setup requirements.</span>
                            </div>
                        </div>
                        <div class="ns-item">
                            <div class="ns-icon">🔑</div>
                            <div class="ns-text">
                                <strong>Hall Access</strong>
                                <span>Present your booking reference at the venue on the day of your event for hall access.</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="action-btns">
                    <a href="Hall.aspx"     class="btn-primary">🏛️ Browse More Halls</a>
