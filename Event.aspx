...
<link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700;800;900&family=Plus+Jakarta+Sans:wght@300;400;500;600;700&display=swap" rel="stylesheet" />
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .sort-select:focus { border-color: var(--violet); box-shadow: 0 0 0 3px var(--violet-glow); }
    ...
    /* ═══════════════════════════════════════
       POSTER GRID  (District by Zomato style)
    ═══════════════════════════════════════ */
    ...
    /* Poster image area — portrait ratio like real event posters */
    ...
    .ev-heart:hover { background: rgba(255,80,80,.7); }
...
<div class="layout">
  ...
  <main class="main">
    ...
    <div class="content">
      ...
      <!-- ── CATEGORY CHIPS ── -->
      <div class="chip-row">
        <asp:LinkButton ID="chipAll"    runat="server" CssClass="chip active" CommandArgument="All" >🎯 All</asp:LinkButton>
        <asp:LinkButton ID="chipFilm"   runat="server" CssClass="chip" CommandArgument="Film"  >🎬 Film</asp:LinkButton>
        <asp:LinkButton ID="chipArts"   runat="server" CssClass="chip"        CommandArgument="Arts"  >🎨 Arts</asp:LinkButton>
        <asp:LinkButton ID="chipComedy" runat="server" CssClass="chip"        CommandArgument="Comedy">🎭 Comedy</asp:LinkButton>
        <asp:LinkButton ID="chipFood"   runat="server" CssClass="chip"        CommandArgument="Food"  >🍽️ Food</asp:LinkButton>
        <asp:LinkButton ID="chipDance"  runat="server" CssClass="chip"        CommandArgument="Dance" >💃 Dance</asp:LinkButton>
        <asp:LinkButton ID="chipSports" runat="server" CssClass="chip"        CommandArgument="Sports">🏅 Sports</asp:LinkButton>
        <asp:LinkButton ID="chipFree"   runat="server" CssClass="chip"        CommandArgument="Free"  >🎁 Free</asp:LinkButton>
        <asp:LinkButton ID="chipMusic"  runat="server" CssClass="chip"        CommandArgument="Music" >🎵 Music</asp:LinkButton>
        ...
        <div class="ev-wide">
          ...
          <div class="ev-wide-body">
            ...
            <div class="ev-wide-footer">
              ...
              <asp:Button ID="btnFeat1" runat="server" CssClass="ev-book-btn" Text="Book Now" CommandArgument="1" />
            </div>
          </div>
        </div>
        ...
        <div class="ev-wide">
          ...
          <div class="ev-wide-body">
            ...
            <div class="ev-wide-footer">
              ...
              <asp:Button ID="btnFeat2" runat="server" CssClass="ev-book-btn" Text="Book Now" CommandArgument="5" />
            </div>
          </div>
        </div>
      ...
      <div class="event-grid">
        ...
        <div class="ev-poster">
          ...
          <div class="ev-poster-body">
            ...
            <div class="ev-poster-footer">
              ...
              <asp:Button ID="btnBook1" runat="server" CssClass="ev-book-btn" Text="Book Now" CommandArgument="2" />
            </div>
          </div>
        </div>
        ...
        <div class="ev-poster">
          ...
          <div class="ev-poster-body">
            ...
            <div class="ev-poster-footer">
              ...
              <asp:Button ID="btnBook2" runat="server" CssClass="ev-book-btn" Text="Register" CommandArgument="3" />
            </div>
          </div>
        </div>
        ...
        <div class="ev-poster">
          ...
          <div class="ev-poster-body">
            ...
            <div class="ev-poster-footer">
              <div class="ev-poster-price free">Free Entry</div>
              <asp:Button ID="btnBook3" runat="server" CssClass="ev-book-btn" Text="Explore" CommandArgument="4" />
            </div>
          </div>
        </div>
        ...
        <div class="ev-poster">
          ...
          <div class="ev-poster-body">
            ...
            <div class="ev-poster-footer">
              ...
              <asp:Button ID="btnBook4" runat="server" CssClass="ev-book-btn" Text="Book Now" CommandArgument="6" />
            </div>
          </div>
        </div>
        ...
        <div class="ev-poster">
          ...
          <div class="ev-poster-body">
            ...
            <div class="ev-poster-footer">
              ...
              <asp:Button ID="btnBook5" runat="server" CssClass="ev-book-btn" Text="Book Now" CommandArgument="7" />
            </div>
          </div>
        </div>
        ...
        <div class="ev-poster">
          ...
          <div class="ev-poster-body">
            ...
            <div class="ev-poster-footer">
              ...
              <asp:Button ID="btnBook6" runat="server" CssClass="ev-book-btn" Text="Book Now" CommandArgument="8" />
            </div>
          </div>
        </div>
        ...
        <div class="ev-poster">
          ...
          <div class="ev-poster-body">
            ...
            <div class="ev-poster-footer">
              ...
              <asp:Button ID="btnBook7" runat="server" CssClass="ev-book-btn" Text="Book Now" CommandArgument="9" />
            </div>
          </div>
        </div>
        ...
        <div class="ev-poster">
          ...
          <div class="ev-poster-body">
            ...
            <div class="ev-poster-footer">
              <div class="ev-poster-price free">Free Entry</div>
              <asp:Button ID="btnBook8" runat="server" CssClass="ev-book-btn" Text="Register" CommandArgument="10" />
            </div>
          </div>
        </div>
      ...
      <div class="pagination">
        <asp:LinkButton ID="btnPrev"  runat="server" CssClass="page-btn arrow">‹</asp:LinkButton>
        <asp:LinkButton ID="btnPage1" runat="server" CssClass="page-btn active" CommandArgument="1">1</asp:LinkButton>
        <asp:LinkButton ID="btnPage2" runat="server" CssClass="page-btn"        CommandArgument="2">2</asp:LinkButton>
        <asp:LinkButton ID="btnPage3" runat="server" CssClass="page-btn"        CommandArgument="3">3</asp:LinkButton>
        <asp:LinkButton ID="btnPage4" runat="server" CssClass="page-btn"        CommandArgument="4">4</asp:LinkButton>
        <asp:LinkButton ID="btnNext"  runat="server" CssClass="page-btn arrow">›</asp:LinkButton>
      </div>
